...
//
//        AdminPersistentToken token = getPersistentToken(cookieTokens);
...
//        AdminPersistentToken token = userRepository.findOneByLogin(login).map(u -> {
//            AdminPersistentToken t = new AdminPersistentToken();
...
//     */
//    private AdminPersistentToken getPersistentToken(String[] cookieTokens) {
...
//        AdminPersistentToken token = persistentTokenRepository.findOne(presentedSeries);
//
//        if (token == null) {
...
//    }
//
//    private void addCookie(AdminPersistentToken token, HttpServletRequest request, HttpServletResponse response) {
//        setCookie(
