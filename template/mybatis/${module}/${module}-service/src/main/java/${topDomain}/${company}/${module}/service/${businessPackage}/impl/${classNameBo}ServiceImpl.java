...
package ${basepackage}.service.${table.businessPackage}.impl;
</#if>
<#if !hasBusinessPackage>
...
public class ${className}ServiceImpl extends AbstractPageService<${pkType}, I${className}DAO, ${className}> implements I${className}Service{
    @Autowired
